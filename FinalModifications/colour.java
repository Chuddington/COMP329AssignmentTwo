...
public class colour extends DefaultInternalAction {
	 ...
	 */
	public colour() {
		comm = new SRComms("LEGOBOT-12", "00:16:53:1c:64:97");		//name and address of the robot.
	...
	public Object execute(TransitionSystem ts, Unifier un, Term[] args) throws Exception {
		...
		String s = comm.readItem();							//get the string with information on a victim from the robot.
